...
<head>
    ...
    <title>Order Notification | FoodMate</title>
</head>
...
<div class="container-fluid">
    <div class="container" style="background-color: #f9f9f9; width: 600px; margin: auto; padding: 30px">
        <div class="col-12 mx-auto" style="width: 580px;  margin: 0 auto;">
            ...
            <div class="row" style="background-color: #1a1a1a; height: 200px;  padding: 35px; color: white;">
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <b style="text-transform: capitalize">{{ $order->full_name}}</b>
                            <br>
                            <span>
                        ...
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            <b>Order date:</b> {{ date('H:i / M d, Y', strtotime($order->created_at)) }}
                            <br>
                        ...
                        <td>
                            ...
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                    ...
                                    You will pay on delivery. We process and have just handed over your food to a shipping partner.
                                    If there is no change, your order will be delivered by <b>{{date('H:i / M d, Y', strtotime($order->delivery_estimated))}}</b> at the latest.
                                </span>
                            </td>
                    ...
                    <div class="row pl-3 py-2"
                        ...
                        <div class="col-12 p-0">
                            <table class="mt-2 w-100"
                                   style="font-size: 16px; width: 100%; text-align: left; margin-top: 5px;margin-bottom: 5px;">
                                <tr>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    <div class="row pl-3 py-2" style="background-color: #1a1a1a; padding: 10px 0 10px 20px;">
                        <b style="color: whitesmoke; font-size: 18px;">More information</b>
                    </div>
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        <p>You can check the food (quality, quantity, restaurant confirmation ... ) before
                            payment and can refuse to receive the food not satisfied.</p>

                        <p>If the food has bad quality or does not match the information on the
                            website, please contact the store within 12 hours from the time of receipt for
                            assistance.</p>
                        ...
                        <b><span style="text-transform: capitalize">{{$order->restaurant->restaurant_name}}</span> thank you <3.</b>
                    </div>
                </div>
            </div>
